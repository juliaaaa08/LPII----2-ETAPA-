...
<html lang="pt-br">
  ...
  <body>
    <div class="container">
        ...
        <input type="text" class="form-control" id="descricao" name="descricao" value="<?php echo $descricao?>"required> <!--?= é a mesma coisa que o ?php echo $descricao? -->
          </div>
        
          <div class="mb-3">
        <label for="preco" class="form-label">Preço</label>
        <input type="number" class="form-control" id="preco" name="preco" value="<?php echo $preco?>" required>
          </div>
        ...
        <div class="mb-3 text-end">
            <button type="button" class="btn btn-danger" onclick="history.go(-1)">Voltar</button> <!--Pega o histórico da página e reduz a 1. Para o history funcionar, precisa ser button-->
    ...
    <p>Clique <a href='listar_produtos.php'>aqui</a> para acessar</p>
