...
<html lang="pt-br">
  ...
  <body>
    <div class="container">
        <h1 class="mt-3 text-center" >Visualizção de Aluno</h1>
        <hr>
...
<div class="row">
            ...
            <button type="button" class="btn btn-primary" onclick="location.href='editar_aluno.php?=php echo $id?';">Editar</button>
            </div>
</div>
    </div>
